...
func (b *Bin) Craft() error {
	...
	files := map[string]string{
		...
		filepath.Join(b.Name, "internal", "status", "testdata", ".gitkeep"): "",
		...
		filepath.Join(b.Name, "pkg", "repository", "testdata", ".gitkeep"):  "",
		...
		filepath.Join(b.Name, "pkg", "secure", "encrypt.go"):                templates.EncryptGo,
